        ...
        <div class="footer_sec">
            ...
            <div class="container">
               ...
               <!-- slideInLeft animated-->
                <div class="col-xs-12 col-md-6 col-lg-6 quick_link ">
                    <h4>Quick Links</h4>
                ...
                <!-- slideInDown animated-->
                  ...
                  <div class="col-sm-6 col-md-3 col-lg-3 our_office contect_link">
        	...
        	<div class="container">
               <div class="row">
			     <div class="col-12 copy-right">
                 	<p>&copy; 2017-<?php echo date("Y")?> 3D Networking. All rights reserved. &nbsp;<a href="http://3d-networking.com/terms-and-conditions">Terms & conditions</a></p>
                 </div>
                </div>
              </div>
        </div>
